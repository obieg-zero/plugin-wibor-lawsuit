...
var wiborLawsuitPlugin = (deps) => {
  const { Box, Cell, Field } = deps.ui;
  const { Shield, Check, Circle } = deps.icons;
  const sdk = deps.sdk;
  _host = deps.host;
  function useSyncCase() {
    const calcApi = sdk.getProvider("wibor-calc");
  ...
  function Left() {
    ...
    return /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(Box, { header: /* @__PURE__ */ jsx(Cell, { label: true, children: "Dane powoda" }), body: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Field, { label: "Imie i nazwisko", children: /* @__PURE__ */ jsx("input", { value: s.plaintiffName, onChange: (e) => saveField("plaintiffName", e.target.value), className: "input input-bordered input-sm w-full", placeholder: "Jan Kowalski" }) }),
        /* @__PURE__ */ jsx(Field, { label: "Adres", children: /* @__PURE__ */ jsx("input", { value: s.plaintiffAddress, onChange: (e) => saveField("plaintiffAddress", e.target.value), className: "input input-bordered input-sm w-full", placeholder: "ul. Dluga 1, 00-001 Warszawa" }) }),
        /* @__PURE__ */ jsx(Field, { label: "PESEL", children: /* @__PURE__ */ jsx("input", { value: s.plaintiffPesel, onChange: (e) => saveField("plaintiffPesel", e.target.value), className: "input input-bordered input-sm w-full", placeholder: "12345678901", maxLength: 11 }) })
      ] }) }),
      /* @__PURE__ */ jsx(Box, { header: /* @__PURE__ */ jsx(Cell, { label: true, children: "Sad i wezwanie" }), body: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsx(Field, { label: "Sad wlasciwy", children: /* @__PURE__ */ jsx("input", { value: s.courtName, onChange: (e) => saveField("courtName", e.target.value), className: "input input-bordered input-sm w-full", placeholder: "Sad Okregowy w Warszawie" }) }),
        /* @__PURE__ */ jsx(Field, { label: "Data wezwania", children: /* @__PURE__ */ jsx("input", { type: "date", value: s.demandDate, onChange: (e) => saveField("demandDate", e.target.value), className: "input input-bordered input-sm w-full" }) }),
  ...
  function Center() {
    ...
    if (!calc?.caseId) return /* @__PURE__ */ jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center space-y-3", children: [
    ...
    if (!result) return /* @__PURE__ */ jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center space-y-3", children: [
    ...
    const hasPlaintiff = !!(s.plaintiffName && s.plaintiffPesel);
    const hasCourt = !!s.courtName;
    const wps = result.overpaidInterest;
    const courtFee = Math.max(30, Math.min(Math.ceil(wps * 0.05), 2e5));
    let statutoryInterest = 0, statutoryDays = 0;
    if (s.demandDate) {
      const demandMs = new Date(s.demandDate).getTime();
      const nowMs = (/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0);
      statutoryDays = Math.max(0, Math.round((nowMs - demandMs) / 864e5));
    ...
    return /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 overflow-y-auto p-3 space-y-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-base-200 rounded-lg p-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)" }, className: "gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-xl font-bold", children: formatPLN(courtFee) })
          ] })
        ] }),
        s.demandDate && /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 mt-3 pt-3 border-t border-base-300", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-lg font-bold", children: formatPLN(statutoryInterest) }),
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "text-lg font-bold text-primary", children: formatPLN(wps + statutoryInterest) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-base-200 rounded-lg p-3", children: [
        ...
        /* @__PURE__ */ jsx("table", { className: "table table-xs", children: /* @__PURE__ */ jsxs("tbody", { children: [
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Kwota kredytu" }),
            /* @__PURE__ */ jsx("td", { className: "text-right", children: calc.input ? formatPLN(calc.input.loanAmount) : "-" })
          ] }),
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Rata z WIBOR" }),
            /* @__PURE__ */ jsx("td", { className: "text-right", children: formatPLN(result.currentInstallment) })
          ] }),
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Rata bez WIBOR" }),
            /* @__PURE__ */ jsx("td", { className: "text-right", children: formatPLN(result.installmentNoWibor) })
          ] }),
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Roznica miesieczna" }),
          ...
          /* @__PURE__ */ jsxs("tr", { className: "font-bold", children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Nadplata odsetkow" }),
            /* @__PURE__ */ jsx("td", { className: "text-right", children: formatPLN(result.overpaidInterest) })
          ] }),
          /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Przyszla oszczednosc" }),
            /* @__PURE__ */ jsx("td", { className: "text-right", children: formatPLN(result.futureSavings) })
          ] }),
          /* @__PURE__ */ jsxs("tr", { className: "font-bold", children: [
            /* @__PURE__ */ jsx("td", { className: "text-base-content/50", children: "Laczna korzysc" }),
  ...
  function Footer() {
    ...
    const fee = Math.max(30, Math.min(Math.ceil(wps * 0.05), 2e5));
    return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 px-3 text-2xs text-base-content/40", children: [
      ...
      /* @__PURE__ */ jsxs("span", { children: [
        "Oplata: ",
        /* @__PURE__ */ jsx("strong", { children: formatPLN(fee) })
      ] })
    ] });
  }
  return {
...
var index_default = wiborLawsuitPlugin;
export {
